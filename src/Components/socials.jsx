  ...
  render() {
    return (
      <div className="row container-fluid justify-content-center">
        ...
        <span>
        <a id="github" className="fas fa-file" href="https://quinnipiacuniversity-my.sharepoint.com/:b:/g/personal/jsruiz_quinnipiac_edu/ESAPBbbfzqlBi9J2VCSCyJUBoptraVn-rCZ6p1xWL5EnKQ?e=ymqW2W"  style={{ textDecoration: 'none' }} ></a>
        </span>
      </div>
    );
  }
